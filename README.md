...
```shell
bash <(curl -fsSL https://gist.githubusercontent.com/mike-fam/2e96087b42abd80776ad5d93c11c7c03/raw/dotfiles_install.sh) git@github.com:mike-fam/.dotfiles.git # Change this to your repository
```
